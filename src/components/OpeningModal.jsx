        ...
        <div className="flyer-content">
          ...
          <div className="flyer-info">
            <div className="info-item">
              ...
              <span className="info-value">12 de junio · Cámara de Comercio</span>
            </div>
            <div className="info-item">
            ...
            <div className="info-item">
              ...
              <span className="info-value">Calle 3 # 32-35, Aguachica</span>
            </div>
          </div>
          ...
          <button className="flyer-button" onClick={handleKnowMore}>
            Conocer más
          </button>
        </div>
      </div>
